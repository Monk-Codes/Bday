...
class Shape {
 ...
 draw(i) {
  ...
  ctx.quadraticCurveTo(this.x - this.r / 20 - this.r / 10, this.y + this.r + this.r / 20 + this.r / 20, this.x - this.r / 20 - this.r / 20, this.y + this.r + this.r / 20 + this.r / 20 + this.r / 20);
  ctx.lineTo(this.x + this.r / 20 + this.r / 20, this.y + this.r + this.r / 20 + this.r / 20 + this.r / 20);
  ctx.quadraticCurveTo(this.x + this.r / 20 + this.r / 10, this.y + this.r + this.r / 20 + this.r / 20, this.x + this.r / 20 + this.r / 20, this.y + this.r + this.r / 20);
  ctx.lineTo(this.x + this.r / 20, this.y + this.r + this.r / 20);
  ctx.closePath();
  ctx.fill();
  // mouse hover ???
